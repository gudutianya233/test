  ...
  <div class="common-layout">
    <el-container>
      <el-aside>
        <el-row>
          <el-col :span="12">
            <el-menu active-text-color="#ffffff" background-color="#545c64" class="el-menu-vertical-demo"
...
let breadList = route.currentRoute.value.matched;
const getMatched = () => {
  breadList = route.currentRoute.value.matched;
};
onBeforeRouteUpdate(()=>{
  breadList = route.currentRoute.value.matched;
